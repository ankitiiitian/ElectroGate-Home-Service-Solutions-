...
function StringLED() {
  ...
  return (
    ...
    <div className='ac'>
        <img className="ac_image" src="https://wallpaper-mania.com/wp-content/uploads/2018/09/High_resolution_wallpaper_background_ID_77701008644.jpg" alt=""/>
        <form style={{
            //  margin: "auto",
            padding: "10px",
            maxWidth: "400px",
