...
function Kettle() {
  ...
  return (
    ...
    <div className='ac'>
        <img className="ac_image" src="https://reviewed-com-res.cloudinary.com/image/fetch/s--vHF3zhd8--/b_white,c_limit,cs_srgb,f_auto,fl_progressive.strip_profile,g_center,q_auto,w_1200/https://reviewed-production.s3.amazonaws.com/1624881928716/oxo.jpg" alt=""/>
        <form style={{
            //  margin: "auto",
            padding: "10px",
            maxWidth: "400px",
