...
function MixerG() {
  ...
  return (
    ...
    <div className='ac'>
        <img className="ac_image" src="https://pepuphome.com/wp-content/uploads/2021/12/5-Tips-to-Pick-Perfect-Mixer-Grinder-for-Your-Kitchen-1.jpg" alt=""/>
        <form style={{
            //  margin: "auto",
            padding: "10px",
            maxWidth: "400px",
