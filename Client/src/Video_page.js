...
function Clock() {
  ...
  return (
    ...
    <div className='ac'>
        <img className="ac_image" src="https://streambmw.com/audiconcord_onlineprocess/audicus-hearing-aids-faq-customer-support.jpeg" alt=""/>
        <form style={{
            //  margin: "auto",
            padding: "10px",
            maxWidth: "400px",
        ...
        >
            ...
            <ButtonGroup className="me-2" aria-label="First group">
                ...
                <Button  style={{width: "60px", color: "white", background: "Red",fontSize: "15px",margin:"5px", padding: "5px", marginLeft: "10px"}} color="info" onClick={() => window.open("/Video_form")}>Book Now</Button>
                <Button  style={{width: "60px", color: "black", background: "LightGreen",fontSize: "15px",margin:"5px", padding: "5px", marginLeft: "10px"}} color="info" onClick={() => window.open("/VideoCall")}>Video Call</Button>
            </ButtonGroup>
            
           
        </form>
        <div style={{marginTop: "10px"}}>
            <h2 style={{ color:"white", textAlign: "center"}}>Search Your Best Consultant 24*7</h2>
