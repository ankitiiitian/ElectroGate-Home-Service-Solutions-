...
function WaterPure() {
  ...
  return (
    ...
    <div className='ac'>
        <img className="ac_image" src="https://apexwaterfilters.com/wp-content/uploads/2018/10/Things-to-Know-Before-Buying-a-Water-Filter-1180x562.jpg" alt=""/>
        <form style={{
            //  margin: "auto",
            padding: "10px",
            maxWidth: "400px",
