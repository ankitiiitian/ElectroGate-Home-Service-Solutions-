...
function Gaming() {
  ...
  return (
    ...
    <div className='ac'>
        <img className="ac_image" src="https://static.techspot.com/images2/news/bigimage/2019/06/2019-06-05-image-18.jpg" alt=""/>
        <form style={{
            //  margin: "auto",
            padding: "10px",
            maxWidth: "400px",
        ...
        >
            ...
            <ButtonGroup className="me-2" aria-label="First group">
                ...
                <Button  style={{width: "60px", color: "white", background: "Red",fontSize: "15px",margin:"5px", padding: "5px", marginLeft: "10px"}} color="info" onClick={() => window.open("/Ins_form")}>Order</Button>
            </ButtonGroup>
