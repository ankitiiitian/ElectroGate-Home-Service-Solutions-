...
function KitchenHood() {
  ...
  return (
    ...
    <div className='ac'>
        <img className="ac_image" src="https://hisense.co.uk/wp-content/uploads/2019/01/Hisense_Lifestyle_Hoods_1928x1051@2x-e1547122945226.jpg" alt=""/>
        <form style={{
            //  margin: "auto",
            padding: "10px",
            maxWidth: "400px",
