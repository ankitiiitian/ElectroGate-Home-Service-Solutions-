...
function Speaker() {
  ...
  return (
    ...
    <div className='ac'>
        <img className="ac_image" src="https://images.unsplash.com/photo-1582978571763-2d039e56f0c3?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTh8fGJsdWV0b290aCUyMHNwZWFrZXJzfGVufDB8fDB8fA%3D%3D&w=1000&q=80" alt=""/>
        <form style={{
            //  margin: "auto",
            padding: "10px",
            maxWidth: "400px",
